...
function blocksRoutineBegin(snapshot) {
  return async function () {
    ...
    blocksComponents.forEach( function(thisComponent) {
...
function instrControllerLoopBegin(instrControllerLoopScheduler, snapshot) {
  return async function() {
    ...
    instrController.forEach(function() {
...
function debriefControllerLoopBegin(debriefControllerLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    debriefController.forEach(function() {
...
function instrPrepRoutineBegin(snapshot) {
  return async function () {
    ...
    instrPrepComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function demographicsQuestRoutineBegin(snapshot) {
  return async function () {
    ...
    demographicsQuestComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Space_StartRoutineBegin(snapshot) {
  return async function () {
    ...
    Space_StartComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function pracBlockInstRoutineBegin(snapshot) {
  return async function () {
    ...
    pracBlockInstComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function pracChoiceRoutineBegin(snapshot) {
  return async function () {
    ...
    pracChoiceComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function pracSelectRoutineBegin(snapshot) {
  return async function () {
    ...
    pracSelectComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function pracFeedRoutineBegin(snapshot) {
  return async function () {
    ...
    pracFeedComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function pracUpdateRoutineBegin(snapshot) {
  return async function () {
    ...
    pracUpdateComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function pracBlockCompleteRoutineBegin(snapshot) {
  return async function () {
    ...
    pracBlockCompleteComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function rewardSetUpRoutineBegin(snapshot) {
  return async function () {
    ...
    rewardSetUpComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function realBlockInstrRoutineBegin(snapshot) {
  return async function () {
    ...
    realBlockInstrComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function realChoiceRoutineBegin(snapshot) {
  return async function () {
    ...
    realChoiceComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function realSelectRoutineBegin(snapshot) {
  return async function () {
    ...
    realSelectComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function realFeedRoutineBegin(snapshot) {
  return async function () {
    ...
    realFeedComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function realUpdateRoutineBegin(snapshot) {
  return async function () {
    ...
    realUpdateComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function blockUpdateRoutineBegin(snapshot) {
  return async function () {
    ...
    blockUpdateComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function blockEndQuestRoutineBegin(snapshot) {
  return async function () {
    ...
    blockEndQuestComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function contRoutineRoutineBegin(snapshot) {
  return async function () {
    ...
    contRoutineComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function rewardChangeRoutineBegin(snapshot) {
  return async function () {
    ...
    rewardChangeComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function taskEnd_1RoutineBegin(snapshot) {
  return async function () {
    ...
    taskEnd_1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function questNextRoutineBegin(snapshot) {
  return async function () {
    ...
    questNextComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function taskEnd_2RoutineBegin(snapshot) {
  return async function () {
    ...
    taskEnd_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function curiosityQuestRoutineBegin(snapshot) {
  return async function () {
    ...
    curiosityQuestComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function cogQuestRoutineBegin(snapshot) {
  return async function () {
    ...
    cogQuestComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function riskQuestRoutineBegin(snapshot) {
  return async function () {
    ...
    riskQuestComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function experimentEndRoutineBegin(snapshot) {
  return async function () {
    ...
    experimentEndComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function debriefPrepRoutineBegin(snapshot) {
  return async function () {
    ...
    debriefPrepComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
